...
### FR-008 — Self-healing drift semantics: a run-log outcome is never drift (Option 3)

- **Imperative:** Machine drift detection treats drift as coming from TWO trustworthy
...
### FR-009 — Self-healing light-up: adversarial-audit corrections

- **Imperative:** Scope a trustworthiness claim to the lane actually verified, and
